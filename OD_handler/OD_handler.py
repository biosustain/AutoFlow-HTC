...
def argument_parser(argv_list=None):
	...
	if args.estimations == False and args.figures == False and args.individual == False and  args.summary == False :
...
def vol_correlation(df_gr, df_vl): #done
	...
	df_gr 	-- dataframe with bioshaker column added.
	'''
