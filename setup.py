...
setup(
    ...
    install_requires=['xcode','setuptools','Cython','wheel','numpy','matplotlib','pandas==1.1.1','datetime','argparse','path','xlsxwriter', 'seaborn', 'scipy', 'pycodestyle','sphinx','sphinx_rtd_theme','xlrd'],
